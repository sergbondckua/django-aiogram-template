...
def c_get_hello(full_name: str) -> str:
    return f"Привіт, {full_name}! В мене відсутня деяка інформація про тебе." \
           "Ти погоджуєшся надати інформацію?"
...
def c_share_phone_number_thx(first_name: str) -> str:
    return text(
        ...
        text(
            "   •",
            hbold(first_name + ","),
            hitalic(_("твій номер телефону надійно збережено та буде "
...
c_input_birthday = _(
    "Напиши та відправ мені свою дату народження в відповідному форматі "
    "- дд.мм.рррр (31.12.2000)"
    "• Для правильної організації тренувального процесу та участі в змаганнях - необхідно знати твій вік."
...
c_input_phone_number = _(
    "Для повноцінного контакту, надай свій номер телефону."
    "• Його будуть бачити тільки адміністрація клубу 📲"
)
